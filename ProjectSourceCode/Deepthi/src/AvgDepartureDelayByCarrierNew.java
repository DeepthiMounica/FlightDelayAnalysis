...
public class AvgDepartureDelayByCarrierNew {

    public static class AvgDepartureDelayByCarrierNewMapper extends Mapper<Object, org.apache.hadoop.io.Text, org.apache.hadoop.io.Text, AverageBean>{
                ...
                if(input.length > 23){
                    ...
                    try{
                        ...
                        if(depDelayInMin < 60) {
                            ...
                            AverageBean outTuple= new AverageBean(totalFlightCount, depDelayInMin);
    ...
    public static class AvgDepartureDelayByCarrierNewReducer extends Reducer<org.apache.hadoop.io.Text, AverageBean, org.apache.hadoop.io.Text, Double> {
    ...
    public static void main( String[] args ){
        ...
        try {
            ...
            job.setJarByClass(AvgDepartureDelayByCarrierNew.class);
            job.setMapperClass(AvgDepartureDelayByCarrierNewMapper.class);
            job.setReducerClass(AvgDepartureDelayByCarrierNewReducer.class);
