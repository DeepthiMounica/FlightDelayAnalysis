...
public class CarrierDelay {
    ...
    public static class CarrierDelayMapper extends Mapper<Object, org.apache.hadoop.io.Text, org.apache.hadoop.io.Text, AverageBean>{
            ...
            if (!value.toString().contains("ARR_DELAY_NEW")) {
                ...
                if(input.length > 23){
                    ...
                    try{
                        ...
                        double carrierDelay = Double.parseDouble(input[38]);

                        if(arrDelayInMin < 60) {

                            AverageBean outTuple= new AverageBean(totalFlightCount, carrierDelay);
    ...
    public static class CarrierDelayReducer extends Reducer<org.apache.hadoop.io.Text, AverageBean, org.apache.hadoop.io.Text, Double> {
    ...
    public static void main( String[] args ){
        ...
        try {
            ...
            job.setJarByClass(CarrierDelay.class);
