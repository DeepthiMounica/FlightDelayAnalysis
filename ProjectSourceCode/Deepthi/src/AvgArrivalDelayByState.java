...
public class AvgArrivalDelayByState {

    public static class AvgArrivalDelayByStateMapper extends Mapper<Object, org.apache.hadoop.io.Text, org.apache.hadoop.io.Text, AverageBean>{
        ...
        protected void map(Object key, org.apache.hadoop.io.Text value, Mapper<Object, org.apache.hadoop.io.Text, org.apache.hadoop.io.Text, AverageBean>.Context context)
            ...
            if (!value.toString().contains("ARR_DELAY_NEW")) {
                ...
                if(input.length > 23){
                    ...
                    org.apache.hadoop.io.Text state = new org.apache.hadoop.io.Text();
                    ...
                    try{
                        ...
                        //double depDelayInMin = Double.parseDouble(input[23]);
                            ...
                            state.set(input[12].trim());

                            context.write(state, outTuple);
    ...
    public static class AvgArrivalDelayByStateReducer extends Reducer<org.apache.hadoop.io.Text, AverageBean, org.apache.hadoop.io.Text, Double> {
    ...
    public static void main( String[] args ){
        ...
        try {
            ...
            job.setJarByClass(AvgArrivalDelayByState.class);
            job.setMapperClass(AvgArrivalDelayByStateMapper.class);
            job.setReducerClass(AvgArrivalDelayByStateReducer.class);
